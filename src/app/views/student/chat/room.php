...
<style>
    ...
    .message.received .message-avatar.teacher {
        background: linear-gradient(135deg, #22c55e, #16a34a);
        margin-right: 10px;
    }
    .message.received .message-avatar.student {
        ...
        <div class="chat-wrapper">
            ...
            <div class="chat-main">
                <div class="chat-header">
                    ...
                    <small>Giảng viên: <?= htmlspecialchars($data['groupInfo']['teacher_name']) ?> • <?= count($data['members']) ?> thành viên</small>
                </div>
                    ...
                    <?php foreach ($data['messages'] as $msg): ?>
                        ...
                        <div class="message <?= $isSent ? 'sent' : 'received' ?>">
                            ...
                            <div class="message-content">
                                <?php if (!$isSent): ?>
                                    <div class="message-sender <?= $msg['role'] ?>">
                        ...
                        <div class="member-item">
                            ...
                            <div class="member-info">
                                ...
                                <div class="member-role">
                                    <?= $member['role'] === 'teacher' ? 'Giảng viên hướng dẫn' : 'Sinh viên - ' . $member['student_code'] ?>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
...
function renderMessages(messages) {
    ...
    messages.forEach(msg => {
        ...
        const roleLabel = msg.role === 'teacher' ? ' (GV)' : '';
        
        div.innerHTML = `
            <div class="message-avatar ${roleClass}">${msg.full_name.charAt(0).toUpperCase()}</div>
            <div class="message-content">
                ${!isSent ? `<div class="message-sender ${roleClass}">${msg.full_name}${roleLabel}</div>` : ''}
