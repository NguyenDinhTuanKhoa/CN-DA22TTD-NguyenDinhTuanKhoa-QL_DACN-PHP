...
<div class="d-flex">
    ...
    <div class="main-content flex-grow-1 p-4">
        <div class="container-fluid">
            <h2 class="mb-4"><i class="bi bi-chat-dots"></i> Tin nhắn với sinh viên</h2>
                ...
                <div class="card-body p-0">
                    <?php if (empty($data['chatGroups'])): ?>
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Nhóm chat sẽ được tạo tự động khi duyệt đăng ký đề tài</p>
                        </div>
                    <?php else: ?>
                            ...
                            <a href="<?= BASE_URL ?>/chat/room/<?= $group['group_id'] ?>" class="text-decoration-none text-dark">
                                <div class="chat-list-item d-flex align-items-center">
                                    <div class="chat-avatar me-3">
                                        <?= strtoupper(substr($group['student_name'], 0, 1)) ?>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <h6 class="mb-1"><?= htmlspecialchars($group['student_name']) ?></h6>
