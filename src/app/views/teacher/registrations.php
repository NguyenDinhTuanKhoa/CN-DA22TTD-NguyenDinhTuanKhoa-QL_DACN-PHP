                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="alert alert-info">
                                                                    <p class="mb-1"><strong>Sinh viên:</strong> <?= $reg['student_name'] ?> (<?= $reg['student_code'] ?>)</p>
                                                                    <p class="mb-0"><strong>Đề tài:</strong> <?= $reg['topic_title'] ?></p>
                                                                </div>
                                                                <p class="text-muted small">Sinh viên sẽ nhận được thông báo qua hệ thống.</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                                                <a href="/PHP-CN/public/teacher/approveRegistration/<?= $reg['registration_id'] ?>" 
                                                ...
                                                <div class="modal fade" id="rejectModal<?= $reg['registration_id'] ?>" tabindex="-1">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                                                <a href="/PHP-CN/public/teacher/rejectRegistration/<?= $reg['registration_id'] ?>" 
                            ...
                            if (!empty($approvedRegs)): ?>
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php foreach ($approvedRegs as $index => $reg): ?>
                                                <tr>
                                                    <td><?= $index + 1 ?></td>
                                                    <td><strong><?= $reg['student_code'] ?></strong></td>
                                                    <td><?= $reg['student_name'] ?></td>
                            ...
                            if (!empty($rejectedRegs)): ?>
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php foreach ($rejectedRegs as $index => $reg): ?>
                                                <tr>
                                                    <td><?= $index + 1 ?></td>
                                                    <td><strong><?= $reg['student_code'] ?></strong></td>
                                                    <td><?= $reg['student_name'] ?></td>
