<div class="sidebar bg-dark text-white p-3" style="width: 250px; min-height: 100vh;">
    ...
    <nav class="nav flex-column">
        <a href="<?= BASE_URL ?>/student" class="nav-link text-white">
            <i class="bi bi-house-door-fill"></i> Trang chủ
        </a>
        <a href="<?= BASE_URL ?>/student/topics" class="nav-link text-white">
            <i class="bi bi-journal-text"></i> Danh sách đề tài
        </a>
        <a href="<?= BASE_URL ?>/student/progress" class="nav-link text-white">
            <i class="bi bi-graph-up"></i> Báo cáo tiến độ
        </a>
        <a href="<?= BASE_URL ?>/student/notifications" class="nav-link text-white">
            <i class="bi bi-bell-fill"></i> Thông báo
        </a>
        <a href="<?= BASE_URL ?>/chat" class="nav-link text-white">
            <i class="bi bi-chat-dots-fill"></i> Tin nhắn
        </a>
        <a href="<?= BASE_URL ?>/student/submission" class="nav-link text-white">
            <i class="bi bi-cloud-upload-fill"></i> Nộp bài đồ án
        </a>
        <a href="<?= BASE_URL ?>/student/profile" class="nav-link text-white">
